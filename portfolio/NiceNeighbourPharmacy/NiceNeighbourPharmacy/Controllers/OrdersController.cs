...
namespace NiceNeighbourPharmacy.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,collect_time,total_price,status,CustomerId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,collect_time,total_price,status,CustomerId")] Order order)
        {
            if (ModelState.IsValid)
            {
